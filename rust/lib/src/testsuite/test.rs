...
use crate::networks::network_context::NetworkContext;
...
pub trait Test<Network> {
	...
	fn setup(network_ctx: NetworkContext) -> Result<Network, Box<dyn Error>>;
	...
	fn run(network: Network, test_ctx: TestContext);
