...
trait TestSuiteConfigurator {
	 ...
	 */
	fn set_log_level(log_level_str: &str) -> Result<(), Box<dyn Error>>;
	...
	fn parse_params_and_create_suite(params_json_str: &str) -> Result<(), Box<dyn Error>>;
}
