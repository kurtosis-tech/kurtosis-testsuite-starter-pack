...
import { ServiceID, NetworkContext, Network } from "kurtosis-core-api-lib";
import { TestConfigurationBuilder } from "kurtosis-testsuite-api-lib"; //TODO
...
class BasicDatastoreAndApiTest {
	...
	public setup(networkCtx: NetworkContext): Result<Network, Error> {
