...
* Upgraded Kurt Core version to 1.27.1 in `build-and-run-core` script
* Deleted `release` script because there is no release artifact that needs tagging and there is no API
